...
//! is [`crate::placeholder`], shared with the client that writes one. This is
...
impl Server {
    ...
    ///
    /// The rule is [`crate::placeholder`]; this reads the commit out of the
    ...
    fn is_fresh_clone_placeholder(&self, commit_id: &CommitId) -> bool {
        ...
        crate::placeholder::is_fresh_workspace_placeholder(
            commit.description(),
            &parents,
            &root_tree,
