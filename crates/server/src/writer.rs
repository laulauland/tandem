...
pub const DEFAULT_WRITER_TTL: Duration =
    Duration::from_secs(jj_tandem_protocol::http::DEFAULT_WRITER_TTL_SECONDS);
...
pub const MAX_WRITER_TTL: Duration =
    Duration::from_secs(jj_tandem_protocol::http::MAX_WRITER_TTL_SECONDS);
